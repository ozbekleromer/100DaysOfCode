/*
HackerRank Task Explanation Page : https://www.hackerrank.com/challenges/beautiful-days-at-the-movies/problem
*/
'use strict';
...
function beautifulDays(i, j, k) {
    let count = 0;
    for(; i<=j; i++) {
        let num = parseFloat(i.toString().split('').reverse().join(''));
